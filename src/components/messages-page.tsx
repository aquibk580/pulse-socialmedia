    ...
    <div className="fixed inset-0 pt-16 bg-background">
      <div className="h-full flex">
          ...
          <div className="p-6 border-b border-border/50 bg-card/80 backdrop-blur-sm flex-shrink-0">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 text-foreground placeholder-muted-foreground text-sm transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            {conversations.map((conversation) => (
              <div
                ...
                className={cn(
                  "p-4 border-b border-border/30 cursor-pointer transition-all duration-200 hover:bg-muted/50",
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {conversation.unreadCount > 0 && (
                        <div className="bg-primary text-primary-foreground text-xs rounded-full w-5 h-5 flex items-center justify-center ml-2 shadow-md">
        ...
        {selectedConv ? (
          <div className="hidden md:flex flex-1 flex-col bg-background min-w-0">
            ...
            <div className="p-6 border-b border-border/50 flex items-center justify-between bg-card/50 backdrop-blur-sm flex-shrink-0">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="font-semibold text-foreground text-lg">{selectedConv.user.name}</h2>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-muted/50 border border-border rounded-full focus:outline-none focus:ring-2 focus:ring-primary/50 text-foreground placeholder-muted-foreground transition-all"
                  />
                ...
                <button
                  ...
                  className="p-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105"
                >
          ...
          <div className="hidden md:flex flex-1 items-center justify-center bg-gradient-to-br from-background to-muted/20">
            <Card className="p-8 text-center border-0 shadow-lg bg-card/50 backdrop-blur-sm">
