          ...
          <div className="flex-1 space-y-3.5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-1.5">
                <h1 className="text-2xl xl:text-2xl font-extrabold  text-foreground">{profile.name}</h1>
                {profile.isVerified && (
              ...
              <div className="flex gap-3">
                {profile.isOwnProfile ? (
                  <>
                    ...
                    <Button variant="outline" className="bg-transparent shadow-none cursor-pointer rounded-xl" size="icon"  onClick={onSettings}>
                      <Settings className="w-4 h-4" />
                    </Button>
                  </>
                ) : (
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex space-x-5">
                <div className="text-center flex flex-col items-center  md:flex-row ">
                  <span className="text-3xl font-bold text-foreground">{formatNumber(profile.stats.posts)}</span>
                  <span className="text-sm text-foreground/80 ml-1">Posts</span>
                </div>
                <div className="text-center flex flex-col items-center md:flex-row ">
                  <span className="text-3xl font-bold text-foreground">{formatNumber(profile.stats.followers)}</span>
                  <span className="text-sm text-foreground/80 ml-1">Followers</span>
                </div>
                <div className="text-center flex flex-col items-center md:flex-row ">
                  <span className="text-3xl font-bold text-foreground">{formatNumber(profile.stats.following)}</span>
                  <span className="text-sm text-foreground/80 ml-1">Following</span>
                </div>
              </div>
            </div>
            ...
            {profile.isOwnProfile && profile.mutualConnections && (
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[0.82rem] text-foreground/70">
        ...
        <div className="flex space-x-3 sm:space-x-4 overflow-x-auto pb-2 scrollbar-hide py-5">
          ...
          {[1, 2, 3, 4, 5].map((highlight) => (
            <div key={highlight} className="flex-shrink-0">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full ring-2 ring-foreground dark:ring-foreground/40 p-1 cursor-pointer hover:scale-105 transition-transform">
                <img
